...
object XX {
  ...
  Special(1) = 7
}/* internalOutgoingReferences(scalaclean/test/references/internalOutgoingReferences/XX.) - scalaclean/test/references/internalOutgoingReferences/Child# :: scalaclean/test/references/internalOutgoingReferences/Child#bar(). :: scalaclean/test/references/internalOutgoingReferences/Parent#foo(). :: scalaclean/test/references/internalOutgoingReferences/Special. :: scalaclean/test/references/internalOutgoingReferences/Special.`myVar1_=`(). :: scalaclean/test/references/internalOutgoingReferences/Special.`myVar2_=`(). :: scalaclean/test/references/internalOutgoingReferences/Special.apply(). :: scalaclean/test/references/internalOutgoingReferences/Special.myVar2(). :: scalaclean/test/references/internalOutgoingReferences/Special.unapply(). :: scalaclean/test/references/internalOutgoingReferences/Special.update(). :: scalaclean/test/references/internalOutgoingReferences/XX.x. */