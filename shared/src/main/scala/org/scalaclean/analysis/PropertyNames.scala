...
object PropertyNames {
  ...
  val prop_srcRoots = "srcRoots" // Contains source/test roots of what has been compiled.  (Blue/Green folders in Intellij)
  val prop_src = "src"
  ...
  val prop_sourceOsDirSeparator = "sourceDirSep" // The directory separator on the os where metadata was build. ":" of ";"
}
