...
class Test_internalDirectOverrides(model: ProjectModel) extends TestCommon("Test_internalDirectOverrides", model) {
  ...
  override def visitInSource(modelElement: ModelElement): String = {
    ...
    overrides match {
      case Nil => ""
      case refs =>
        debugValues(refs).mkString(s"internalDirectOverrides(${modelElement.modelElementId.debugValue}) - ", " :: ", "")
    }
  }
...
class Test_internalTransitiveOverrides(model: ProjectModel)
  ...
  override def visitInSource(modelElement: ModelElement): String = {
    ...
    overrides match {
      case Nil => ""
      case refs =>
        debugValues(refs).mkString(
          s"internalTransitiveOverrides(${modelElement.modelElementId.debugValue}) - ",
          " :: ",
          ""
        )
    }
...
class Test_internalDirectOverriddenBy(model: ProjectModel)
  ...
  override def visitInSource(modelElement: ModelElement): String = {
    ...
    overrides match {
      ...
      case refs =>
        debugValues(refs).mkString(
          s"internalDirectOverriddenBy(${modelElement.modelElementId.debugValue}) - ",
          " :: ",
          ""
        )
    }
...
class Test_internalTransitiveOverriddenBy(model: ProjectModel)
  ...
  override def visitInSource(modelElement: ModelElement): String = {
    ...
    overrides match {
      ...
      case refs =>
        debugValues(refs).mkString(
          s"internalTransitiveOverriddenBy(${modelElement.modelElementId.debugValue}) - ",
          " :: ",
          ""
        )
    }
