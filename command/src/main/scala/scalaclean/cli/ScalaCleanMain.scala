...
//import scalaclean.rules.deadcode.SimpleDeadCodeRemover
//import scalaclean.rules.privatiser.{AbstractPrivatiser, SimplePrivatiser}
...
//    val parsed: ParsedCommand = ScalaCleanCommandLine.parse(args)
//    new ScalaCleanMain(parsed, "")
//  }
//
//}
//
//class ScalaCleanMain(val parsed: ParsedCommand, expectationSuffix: String)
...
//
//    val rule = parsed.createRunner(projectSet)
