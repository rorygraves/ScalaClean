...
lazy val deadCodeProject20_overridevals =
  testInputProject("deadCodeProject20_overridevals", "testProjects/deadCodeProject20_overridevals")()
...
lazy val deadCodeTests = List(
  ...
  deadCodeProject20_overridevals
)
